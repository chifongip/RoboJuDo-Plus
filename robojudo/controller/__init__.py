...
ctrl_registry.add("RosJoystickCtrl", ".ros_joystick_ctrl")
...
ctrl_registry.add("UpperBodyZmqCtrl", ".upper_body_zmq_ctrl")
ctrl_registry.add("UpperBodyOmniHandZmqCtrl", ".upper_body_omnihand_zmq_ctrl")
ctrl_registry.add("UpperBodyCasiaHandZmqCtrl", ".upper_body_casia_hand_zmq_ctrl")
ctrl_registry.add("Gr00tZmqCtrl", ".gr00t_zmq_ctrl")
ctrl_registry.add("VelocityZmqCtrl", ".velocity_zmq_ctrl")
