...
policy_registry.add("G1BeyondMimicPolicy", ".g1_beyondmimic_policy")
policy_registry.add("X2BeyondMimicPolicy", ".x2_beyondmimic_policy")
...
policy_registry.add("X2Gr00tLocomanipulationPolicy", ".x2_gr00t_locomanipulation_policy")
...
policy_registry.add("G1Gr00tLocomanipulationPolicy", ".g1_gr00t_locomanipulation_policy")
