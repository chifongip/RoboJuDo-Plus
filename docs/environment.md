...
> [UnitreeCpp](https://github.com/chifongip/unitree_cpp) is needed.

This environment is implemented with [UnitreeCpp](https://github.com/chifongip/unitree_cpp). In our test onboard Unitree G1, `UnitreeCppEnv` is faster almost 100 times than `UnitreeEnv` in `step()`.
